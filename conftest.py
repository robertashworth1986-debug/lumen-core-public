"""Clean-checkout test policy for generated and retained evidence artifacts.

The frozen CODECHECK source files must remain byte-identical to their reviewed
commit.  Some publication tests intentionally target files produced later by
the authoritative replay workflow or retained outside Git.  A normal clean
checkout marks only those tests as artifact-dependent when their inputs are
