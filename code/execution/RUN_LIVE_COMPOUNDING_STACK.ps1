...
# Legacy launcher: code\execution\RUN_LIVE_COMPOUNDING_STACK.ps1
# Backup file: code\execution\RUN_LIVE_COMPOUNDING_STACK.ps1.bak_pre_safe_redirect
...
Write-Host "
=== RUN_LIVE_COMPOUNDING_STACK.ps1 redirected to safe no-orders launcher ===" -ForegroundColor Cyan
Write-Host "No broker orders will be submitted from this redirected launcher." -ForegroundColor Yellow
Write-Host "Original backup: code\execution\RUN_LIVE_COMPOUNDING_STACK.ps1.bak_pre_safe_redirect" -ForegroundColor Yellow
