...
PROOF_ARTIFACTS: list[tuple[str, str, bool]] = [
    ...
    ("routing", "code/eia_grid_prospective_router_ops.py", True),
    ("routing", "tools/Run-EiaProspectiveRouterCycle.ps1", True),
    ("routing", "tools/Register-EiaProspectiveRouterTask.ps1", True),
    ...
    ("routing", "docs/EIA_GRID_PROSPECTIVE_ROUTER_OPERATIONS_2026-07-13.md", True),
    ...
    ("routing", "out/eia_grid_prospective_hybrid_router/operational_runs.jsonl", True),
    ("routing", "out/eia_grid_prospective_hybrid_router/prospective_status_latest.json", True),
    ("routing", "out/eia_grid_prospective_hybrid_router/scheduler_cycle_latest.json", True),
    ...
    ("routing", "tests/test_eia_grid_prospective_router_ops.py", True),
    ...
    ("mda", "grant_submissions/MDA26BZ04_NV007_ControlAssessment/MDA26BZ04_NV007_VOLUME1_PUBLIC_TEXT_2026-07-13.md", True),
    ("mda", "grant_submissions/MDA26BZ04_NV007_ControlAssessment/MDA26BZ04_NV007_SYNTHETIC_FEASIBILITY_EVIDENCE_2026-07-13.md", True),
    ("mda", "config/mda_control_mapping_feasibility_protocol_v1.json", True),
    ("mda", "docs/MDA_CONTROL_MAPPING_FEASIBILITY_PREREGISTRATION_2026-07-13.md", True),
    ("mda", "docs/MDA_CONTROL_MAPPING_FEASIBILITY_RESULT_2026-07-13.md", True),
    ("mda", "code/mda_control_mapping_feasibility.py", True),
    ("mda", "tests/test_mda_control_mapping_feasibility.py", True),
    ("mda", "out/mda_control_mapping_feasibility/synthetic_fixtures_latest.jsonl", True),
    ("mda", "out/mda_control_mapping_feasibility/fixture_manifest_latest.json", True),
    ("mda", "out/mda_control_mapping_feasibility/split_manifest_latest.json", True),
    ("mda", "out/mda_control_mapping_feasibility/threshold_selection_receipt_latest.json", True),
    ("mda", "out/mda_control_mapping_feasibility/holdout_predictions_latest.jsonl", True),
    ("mda", "out/mda_control_mapping_feasibility/failure_and_abstention_log_latest.jsonl", True),
    ("mda", "out/mda_control_mapping_feasibility/mda_control_mapping_feasibility_latest.json", True),
    ("mda", "out/mda_control_mapping_feasibility/mda_control_mapping_feasibility_manifest_latest.json", True),
    ("mda", "config/mda_control_mapping_open_set_protocol_v2.json", True),
    ("mda", "docs/MDA_CONTROL_MAPPING_OPEN_SET_PREREGISTRATION_2026-07-13.md", True),
    ("mda", "docs/MDA_CONTROL_MAPPING_OPEN_SET_RESULT_2026-07-13.md", True),
    ("mda", "code/mda_control_mapping_open_set_benchmark.py", True),
    ("mda", "tests/test_mda_control_mapping_open_set_benchmark.py", True),
    ("mda", "out/mda_control_mapping_open_set_v2/synthetic_open_set_fixtures_latest.jsonl", True),
    ("mda", "out/mda_control_mapping_open_set_v2/fixture_manifest_latest.json", True),
    ("mda", "out/mda_control_mapping_open_set_v2/split_manifest_latest.json", True),
    ("mda", "out/mda_control_mapping_open_set_v2/threshold_selection_receipt_latest.json", True),
    ("mda", "out/mda_control_mapping_open_set_v2/holdout_predictions_latest.jsonl", True),
    ("mda", "out/mda_control_mapping_open_set_v2/failure_and_abstention_log_latest.jsonl", True),
    ("mda", "out/mda_control_mapping_open_set_v2/mda_control_mapping_open_set_latest.json", True),
    ("mda", "out/mda_control_mapping_open_set_v2/mda_control_mapping_open_set_manifest_latest.json", True),
