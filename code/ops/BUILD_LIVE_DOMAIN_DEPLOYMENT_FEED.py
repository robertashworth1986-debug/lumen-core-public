...
PROOF_FEEDS = [
    ...
    {
        "key": "grant_readiness_status",
        "local": "dashboard/data/grant_readiness_status.json",
        "required": True,
        "why": "Public grants console and operator-home readiness feed for submission state, blockers, and approval boundary.",
    },
    {
        "key": "top5_live_proof_submission_board",
        "local": "dashboard/data/top5_live_proof_submission_board.json",
        "required": False,
        "why": "Grant-facing shortlist of current proof-backed submission lanes and live proof posture.",
    },
    {
        "key": "deadline_evidence_bridge",
        "local": "dashboard/data/deadline_evidence_bridge.json",
        "required": False,
        "why": "Deadline triage and evidence-to-submission routing context for time-sensitive grants.",
    },
    {
        "key": "baseline_gauntlet_coverage",
        "local": "dashboard/data/baseline_gauntlet_coverage.json",
        "required": False,
        "why": "Named-baseline coverage and remaining comparison gaps for reviewer-facing technical credibility.",
    },
    {
        "key": "kuramoto_accepted_metric_audit",
        "local": "dashboard/data/kuramoto_accepted_metric_audit.json",
        "required": False,
        "why": "Accepted Kuramoto metric audit for order parameter, coupling threshold, and phase-bound evidence framing.",
    },
    {
        "key": "valuation_proposal_target_packet",
        "local": "dashboard/data/valuation_proposal_target_packet.json",
        "required": False,
        "why": "Investor and pilot-target valuation packet with explicit no-field-validation/no-real-dollar-claim boundaries.",
    },
    {
        "key": "outreach_and_application_send_queue",
        "local": "dashboard/data/outreach_and_application_send_queue.json",
        "required": False,
        "why": "Manual outreach/application queue for validation targets, funding paths, and operator send controls.",
    },
    {
...
def build_payload(check_live_domain: bool = True, timeout: int = 10) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "reviewer_urls": {
            ...
            "grant_readiness_status": f"{base}/data/grant_readiness_status.json",
            "top5_live_proof_submission_board": f"{base}/data/top5_live_proof_submission_board.json",
