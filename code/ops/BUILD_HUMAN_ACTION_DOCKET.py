...
STATUS_ACTION_TYPES: dict[str, str] = {
    ...
    "QUALIFIED_RESPONSE_LEAD_REFERRAL_ACKNOWLEDGED_FIT_CHECK_PENDING": "agency_routing_watch",
    "SENT_VERIFIED_RESPONSE_PENDING": "agency_routing_watch",
    "PRIVATE_DSIP_FACTS_CAPTURED_GATES_OPEN": "federal_sbir_build",
