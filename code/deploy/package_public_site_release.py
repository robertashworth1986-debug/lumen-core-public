...
RELEASE_PATHS: Final = (
    ...
    "dashboard/review_sprint.html",
    "dashboard/robots.txt",
    "dashboard/sitemap.xml",
    "dashboard/site.webmanifest",
    "dashboard/assets/lumencore-mark.svg",
    "dashboard/assets/public_site_components.css",
    "dashboard/assets/public_site_core.css",
    "dashboard/assets/public_site_pages.css",
    "dashboard/assets/public_site_responsive.css",
    "dashboard/assets/public_site.js",
    "dashboard/assets/luma_command_fabric.js",
    "dashboard/assets/fonts/inter-latin-variable.woff2",
    "dashboard/assets/fonts/jetbrains-mono-latin-variable.woff2",
    "dashboard/assets/fonts/orbitron-latin-variable.woff2",
    "dashboard/assets/fonts/OFL-Inter.txt",
    "dashboard/assets/fonts/OFL-JetBrains-Mono.txt",
    "dashboard/assets/fonts/OFL-Orbitron.txt",
)
