...
readonly -a RELEASE_FILES=(
  ...
  "assets/public_site_components.css"
  "assets/public_site_core.css"
  "assets/public_site_pages.css"
  "assets/public_site_responsive.css"
  "assets/public_site.js"
  "assets/luma_command_fabric.js"
  "assets/fonts/inter-latin-variable.woff2"
  "assets/fonts/jetbrains-mono-latin-variable.woff2"
  "assets/fonts/orbitron-latin-variable.woff2"
  "assets/fonts/OFL-Inter.txt"
  "assets/fonts/OFL-JetBrains-Mono.txt"
  "assets/fonts/OFL-Orbitron.txt"
)
readonly -a RELEASE_DIRECTORIES=("assets" "assets/fonts")
