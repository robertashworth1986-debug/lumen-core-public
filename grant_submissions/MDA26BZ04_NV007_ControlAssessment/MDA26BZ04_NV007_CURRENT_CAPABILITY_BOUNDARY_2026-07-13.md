...
| Candidate-baseline orchestration | Multiple public-data benchmark runners | Compare static crosswalk, lexical retrieval, and candidate mapping routes | Candidate cyber mapper is proposed work |
