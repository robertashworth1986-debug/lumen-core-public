# Live Funding Portal Handoff - 2026-07-15

Generated for the LumenCore funding sprint. This record distinguishes official-source facts, local package readiness, account gates, and legal/user-only actions.
...
## Source-Verified Priority Queue

| Priority | Opportunity | Official deadline | Current action |
|---|---|---:|---|
...
- The old FHWA TSMO lane in the 2026-07-13 command board must not be treated as a current submission until the exact active solicitation and response deadline are re-verified from the official notice and attachments.
- HHS Enterprise Laptop DaaS RFI is a poor fit: it is centered on device-as-a-service hardware supply and asks for comparable large-federal implementations.
- Expired notices, market-research receipts, and unverified LinkedIn outreach stay outside the award-ready queue.
