...
- Command board SHA-256: `91605c6ba435a3132daa69419807625c142a9391594484e330291d81059fbf0c`
...
- `grant_reviewer_curation`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-17T07:21:42Z` age_hours=`48.435` blocking=`true`
- `grant_reviewer_feed`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-17T07:58:16.957707Z` age_hours=`47.825` blocking=`true`
- `sam_rush_board`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-10T17:17:18.392822Z` age_hours=`206.508` blocking=`true`
- `grants_ranked`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-12T20:57:59.741007Z` age_hours=`154.83` blocking=`true`
- `zero_friction_pack`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-11T13:25:28.922930Z` age_hours=`186.372` blocking=`true`
- `sam_live_discovery`: status=`ZERO_ROW_SAM_RESPONSE_INCONCLUSIVE_BLOCKER` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-17T07:57:56.457071Z` age_hours=`47.831` blocking=`true`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `5afa2bb096f5bb9a611c84055235dd3277b388cc09ef9360636661c7c29979f2`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `ac8c1ab33446804d5c4a5c00f378a398a6382be6e556db2c3a78c3c9ec60cec1`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `3b88ab4563105f2ec56c1f6ff59125188c23f357cd961cabf692b384dd045005`
...
- Command: `STAGE_APPLICATION`
- Eligibility: `CORE_PROJECT_VERIFIED_EXTERNAL_SUBMISSION_FIELDS_OPEN`
- Fit: `DEVELOPER_TOOLS_WORKING_PROJECT_STRONG_FIT`
- Package status: `PORTAL_ONLY`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `PROJECT_CORE_VERIFIED_EXTERNAL_SUBMISSION_FIELDS_OPEN`
- Submission ready: `false`
- Source freshness: `NO_TTL_FEED_DEPENDENCY`
- Deadline actionable: `false`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `8affe58b128ae21b00f27121a08870ed2bef759965cd32fcf79f59dd52782b08`
...
- Why now: This is the nearest complete federal Phase I proposal package. The 15-file manifest verifies byte-for-byte, the technical candidate is claim-bounded, and the official topic fit is strong. It is not submission-ready: the current public action gate is 36/50, and every remaining gate must be resolved without exposing identity, cost, ITAR, CMMC, award-history, foreign-affiliation, rights, preview, or certification values.
- Today work:
...
- Action gates passed: `36/50`
- Action gates open: `14`
- Private input present: `true`
- Private values exposed: `false`
- Ready for human final click: `false`
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `0b01083a826984ddf6ceae0c9def4aecb711e3c18a2d6b58dae90ea4d7e23a26`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `c15307c1e04b9ec080e26563ba346974cf627fa23f5cdd35dbffa42a52669b65`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `a73119f2497f3e548f9079e20a8f04c356cecf4b746b0afa110e74c5955a3dca`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `50fc09d1351a7e5bc3b9db8f3744061587ff27f9e42fd567e62a6d7fa19e3a9f`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `ca255bdc4ad6192553c8f9643872c4955a6438a7d763507d537bc9b4c46a80a7`
...
- Deadline UTC: `2026-08-14T04:59:00Z`
- Official deadline: August 13, 2026 at 11:59 PM Central Daylight Time
- Days to close from scan date: `25`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `29a58661990607f31768837c14d50b43eedb9bf74aefcf1063e1a920b277a43d`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `f861a8288d07e88d4952dfef08edb9f1b2143468303ef5d318583847e505aa62`
...
- Days to close from scan date: `15`
- Deadline bucket: `thirty_day_sprint`
- Command: `NO_SOLO_SUBMIT_PARTNER_ONLY`
- Eligibility: `TEAM_SET_NO_ADDITIONAL_PARTNERS_ROUTE_CLOSED`
- Fit: `STRONG_TECHNICAL_FIT_MANDATORY_CORPORATE_EXPERIENCE_MISSING`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `5e84c6189052d136d83e4c95cdb098399fd728f0d37d1cbfabeec79307823a48`
...
- Deadline UTC: `None`
- Official deadline: NSF 26-510 lists July 27 and November 4, 2026, then March 4 and July 7, 2027, as full-proposal deadlines. July 27 is not currently reachable because no official Project Pitch invitation was verified; November 4 is planning only.
- Days to close from scan date: `108`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `80485920626a16334c54b967281948a476cc846f660925827dc2effc053c154d`
...
- Days to close from scan date: `19`
- Deadline bucket: `thirty_day_sprint`
- Command: `REVERIFY_SOURCE_BEFORE_STAGE`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `885edc4083956b149ce22b9008c65c2b1d1e112481a907a0530e59ed1f4e8415`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `9e35b847a69f2eb9173bc8e23cda7b4af01041cc7d507bee40b82ee1f0a84ad7`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `b5df80d3186251a8fcb43c602720a326aa871efe099d7dc6ac6c4cb9d18e95d8`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `f520b8286c6236ed8748e0638c4e084002e02c8b10dd709fb9d50bea59bce80c`
...
- Package status: `SOURCE_ONLY_NOTICE`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `NOT_READY_HUMAN_GATED`
- Submission ready: `false`
- Source freshness: `NO_TTL_FEED_DEPENDENCY`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `c8ccd2216c72cab5c1c99c1102096c637b6f232e362c2fb2673c79da32559be4`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `c3630a87e3d5bdf4574b62bc7d1ad47369781f0ef87c1d10e77f2aa395c8f478`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `a55b01ef75073f5340d92dc6c41fc754fe8cfd1f5dd23af6867b68677a50d838`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `6bad36bdfd69a0511c19777a6d9837dc51999fc7aa35f932dccd79aa87ddc008`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `117e73d526f908ff7f2f52ac04a3cdaf381013fdd84627a8d9150b6f02e06288`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `b9def2ae5dd8de172daf97a134622271d525efaea9a4569bcea3b3e433291ddb`
...
- `grant_reviewer_curation`: `config/grant_reviewer_curation_v1.json` present=`true` sha256=`8a59d654b799539a38be7b3b2eaf7fd549a1f62da25a909b1d176d951bfea049`
- `grant_reviewer_feed`: `dashboard/data/grant_reviewer_feed.json` present=`true` sha256=`5757cf8d0ca3e96b8aea1892ed54f0758bf4e7c25ccee82a4a9fd2b5c6969282`
- `nv061_concept`: `grant_submissions/NV061_TrackCast/NV061_CONCEPT_DRAFT.md` present=`true` sha256=`6fb2a793b8b08a44111d6197dfa04119a37510fc288ac5ffdf014ff83a8686d6`
- `nv061_readiness`: `grant_submissions/NV061_TrackCast/NV061_READINESS.md` present=`true` sha256=`b782d2364e02ca441d2b8cdc0b5c92b40e8f6af412a47affffc3f2ddbbdc3d2a`
...
- `nv063_readiness`: `grant_submissions/NV063_HarborSentinel/NV063_READINESS.md` present=`true` sha256=`3db7da659fbad1ea3f772583c7220b6f6db03b1cc122f49de9a979f3461b7eef`
- `nv065_concept`: `grant_submissions/NV065_AdaptiveSensorManagement/NV065_CONCEPT_DRAFT.md` present=`true` sha256=`f4841bda8f638609a85ed01fc7fd70cb7bcd9a47f1d7f4e393a2c9b3508efb57`
- `nv065_readiness`: `grant_submissions/NV065_AdaptiveSensorManagement/NV065_READINESS.md` present=`true` sha256=`e618e9d0a5d0d44ac0bd550f4721aecc1b72dd48ad97f7db98ccbf3e802ed6aa`
...
- `nashville_ec_official_deadline_confirmation`: `grant_submissions/NASHVILLE_EC_FALL_2026/NASHVILLE_EC_OFFICIAL_DEADLINE_CONFIRMATION_2026-07-17.json` present=`true` sha256=`dac4b3120d9b4ec2a822198426939b89fe96bf7294c0cc251d1a299bb76b00e2`
- `nashville_ec_submission_receipt`: `grant_submissions/NASHVILLE_EC_FALL_2026/NASHVILLE_EC_SUBMISSION_RECEIPT_2026-07-17.json` present=`true` sha256=`e606530b0ccbab06347bef60de527b4a76e5ee35bd7a15e71c3a0b49647be505`
- `darpa_sn_26_97_submission_receipt`: `grant_submissions/DARPA_SN_26_97/DARPA_SN_26_97_SUBMISSION_RECEIPT_2026-07-17.json` present=`true` sha256=`7d5d3e744a02aef665e1b8acb93b3579abc4a978414958e59e742e7cde8a4ec0`
...
- `missionweave_dsip_action_gate`: `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_ACTION_GATE_2026-07-17.json` present=`true` sha256=`60eb6f4ea94067c653bdcd7b7765aab03df4ad627a99b9c65e4d89c54991f53a`
- `missionweave_dsip_portal_checklist`: `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_PORTAL_CHECKLIST_2026-07-17.md` present=`true` sha256=`2438f3905ecf92193f3cf50ddd1bca617f3c84f3f5f1626fc4058a5ea66eadac`
- `missionweave_dsip_private_capture_tool`: `code/ops/CAPTURE_MISSIONWEAVE_DSIP_PRIVATE_INPUT.py` present=`true` sha256=`adf1fc651ac2002dc59c540265de9433e3f1b570fd2fc14a541bedcb88043ab8`
