# Near-Deadline Submission Command Board - 2026-07-21

This is the action board for getting the closest credible grants and federal contract responses fully staged.

Direct answer: HarborSentinel remains urgent but is not ready; its dedicated package stays visible while stale source, DSIP, package-integrity, eligibility, compliance, cost, and portal gates remain closed. Nashville EC is portal-confirmed; DARPA was sent before deadline and returned a generic procedural response; NASA and Army are sent, and CDC acknowledged receipt. SAM.gov public credential rotation became overdue after 2026-07-16. Use the guarded hidden-input installer immediately, then require changed-fingerprint and live-API verification. Entity registration remains active; credential rotation is a separate account-maintenance action. OpenAI Build Week is submission-confirmed, so preserve its receipt and stage the hash-verified MissionWeave DSIP package for July 22 noon Eastern. Refresh NSF before resuming its rolling Project Pitch staging, close the declined Cambridge FHWA teaming route without another follow-up, and keep DOJ/BOP partner-only.

## Control Line

- Status: `NEAR_DEADLINE_COMMAND_BOARD_ACTIVE_FAIL_CLOSED_FRESHNESS_BLOCKERS`
- Generated UTC: `2026-07-21T18:08:36.636082Z`
- Freshness as-of UTC: `2026-07-21T18:08:36.636082Z`
- Scan date: `2026-07-21`
- Lane count: `23`
- Curated Navy lanes: `3`
- Stage-now lanes: `3`
- Sent and verified lanes: `6`
- Emergency eligibility gates: `0`
- No-bid or partner-only lanes: `6`
- Expired without verified send: `3`
- Human-gated lanes: `14`
- Freshness-blocked lanes: `13`
...
- Command board SHA-256: `5658a15dd176e12c56ba630a871b554963a09b63046eb0d18ecc45ee84932076`

## Source Freshness

- Overall status: `BLOCKED_REVERIFY_REQUIRED`
- TTL hours: `24.0`
- Fail closed: `true`
- Blockers: `6`
...
- `grant_reviewer_curation`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-17T07:21:42Z` age_hours=`106.782` blocking=`true`
- `grant_reviewer_feed`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-17T07:58:16.957707Z` age_hours=`106.172` blocking=`true`
- `sam_rush_board`: status=`STALE_REVERIFY_REQUIRED` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-10T17:17:18.392822Z` age_hours=`264.855` blocking=`true`
...
- `sam_live_discovery`: status=`ZERO_ROW_SAM_RESPONSE_INCONCLUSIVE_BLOCKER` freshness=`STALE_REVERIFY_REQUIRED` source_utc=`2026-07-17T07:57:56.457071Z` age_hours=`106.178` blocking=`true`
...
- Receipt evidence SHA-256: `88A606678ACC62C60C914C515605D5D590CEACDC1A82AA20B47028B3444EEB0D`
- Verification scope: `RECEIPT_RECORD_ONLY`
- Claim boundary: The receipt proves only the recorded transmission state.

### 2. NASHVILLE-EC-FALL-2026 - Nashville Entrepreneur Center Fall 2026 Accelerators

- Status: `PORTAL_SUBMISSION_CONFIRMED`
- Sent UTC: `2026-07-18T04:54:52.709214Z`
- Receipt: `grant_submissions/NASHVILLE_EC_FALL_2026/NASHVILLE_EC_SUBMISSION_RECEIPT_2026-07-17.json`
- Receipt evidence SHA-256: `d2c82aa6a9d91785b72a09fda2753bdae070b100b7efd048e16a952f214c5619`
- Verification scope: `PORTAL_CONFIRMATION_PAGE_OBSERVED`
...
### 3. DARPA-SN-26-97 - Anticipatory Research Program RFI

- Status: `EMAIL_SUBMISSION_SENT_BEFORE_DEADLINE`
- Sent UTC: `2026-07-17T19:27:49Z`
...
- Status: `PORTAL_SUBMISSION_CONFIRMED`
- Sent UTC: `2026-07-21T16:00:55Z`
- Receipt: `evidence/openai_build_week/prooflock_youtube_publication_receipt_20260721.json`
- Receipt evidence SHA-256: `c83e6e722ee80670b5a3435684e007c85f2544a99e68282259ec811cae9a78fb`
- Verification scope: `PUBLIC_PROJECT_PAGE_AND_CONFIRMATION_EMAIL_OBSERVED`
- Claim boundary: This receipt records the observed YouTube publication state, declared local source-video and narration identities, transcript-QA boundaries, Robert's report that he completed submission, the publicly resolved Devpost page showing ProofLock Console submitted to OpenAI Build Week with the matching video embedded, and Devpost's submission-confirmation email. It does not independently prove that terms were read, contest acceptance beyond successful submission, judging, award, OpenAI endorsement, external validation, engineering performance, safety, patent rights, funding, or commercial readiness.
...
- Receipt: `grant_submissions/funding_sprint_20260709/EXTERNAL_SUBMISSION_RECEIPT_2026-07-13.json`
- Receipt evidence SHA-256: `D0528488B91C940E2A8401E3571BE72C59124F714883E25CF6D7D7716427B8BF`
- Verification scope: `RECEIPT_RECORD_ONLY`
- Claim boundary: The receipt proves only the recorded transmission state.

### 11. 75D301-26-RFI-73483 - CDC Artificial Intelligence for Acquisition Support Reverse Industry Day
...
- Receipt evidence SHA-256: `570F6A6C86DD03649B6F5EE7F731D5E3F0884712CD06DA588D2A4C92C903B2B1`
- Verification scope: `RECEIPT_RECORD_ONLY`
...
### 5. DLA26BZ03-NV011 - Digital Twin of the Organization for Enhanced Mission Readiness

- Command: `STAGE_DSIP_PROPOSAL`
- Deadline UTC: `2026-07-22T16:00:00Z`
- Official deadline: July 22, 2026 at 12:00 p.m. Eastern Time. The SBIR.gov topic record and DLA Release 3 schedule agree on July 22, 2026; the downloaded Amendment 2 BAA schedule line prints July 22, 2025, an apparent internal year typo. Reconfirm the live DSIP countdown before submission.
- Official URL: https://www.sbir.gov/topics/12778
- Package files:
  - `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_PACKAGE_MANIFEST_2026-07-16.json`
  - `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_ASSEMBLY_MAP_2026-07-16.md`
  - `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_VOLUME1_PUBLIC_TEXT_2026-07-16.md`
  - `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_VOLUME2_FINAL_CANDIDATE_2026-07-16.pdf`
  - `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_VOLUME3_COST_INPUTS_2026-07-16.md`
  - `grant_submissions/DLA26BZ03_NV011_MissionWeave/MISSIONWEAVE_DSIP_VOLUME5_WORKSHEET_2026-07-16.md`
...
### 10. LAUNCHTN-3686-2026 - 3686 Pitch Competition 2026, presented by Amazon
...
### 13. 26-510 - NSF Small Business Innovation Research / Small Business Technology Transfer Programs Phase I
...
- Prior command: `None`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
...
- Prior command: `ASSEMBLE_DSIP_PROPOSAL`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
- Submission ready: `false`
- Blockers:
  - `grant_reviewer_curation:STALE_REVERIFY_REQUIRED`
  - `DSIP_CONTROLLING_NOTICE_RECHECK_REQUIRED`
  - `MANIFEST_REVERIFY_REQUIRED`

### 7. DON26BZ03-NV065 - Adaptive Sensor Management

- Command: `REVERIFY_SOURCE_BEFORE_STAGE`
- Prior command: `DEVELOP_CONCEPT`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
- Submission ready: `false`
- Blockers:
...
### 12. 693JJ326R000012 - Transportation Systems Management and Operations Data Initiative
...
### 14. W912HZ26SC005 - Sovereign Defense Cloud for High-Performance Computing Commercial Solutions Opening

- Command: `REVERIFY_SOURCE_BEFORE_STAGE`
- Prior command: `STAGE_CONCEPT_PAPER`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
- Submission ready: `false`
- Blockers:
...
### 15. 15BCMS26Q70000005 - Historical Medical Claims Data Analysis
...
### 16. 1131PL26R0049 - Indo-Pacific Digital Infrastructure Project Scoping Services
...
### 20. 693JJ3-26-BAA-0004 - Intersection Safety Systems Prototyping
...
### 21. 7571TE26R00004 - HHS AI Power User Advanced Models and Features Pilot
...
- Eligibility: `TEAM_SET_NO_ADDITIONAL_PARTNERS_ROUTE_CLOSED`
- Fit: `STRONG_TECHNICAL_FIT_MANDATORY_CORPORATE_EXPERIENCE_MISSING`
- Package status: `NO_BID`
- Portal status: `NO_PORTAL_ACTION_AUTHORIZED`
...
### 22. 26-508 - TechAccess: AI-Ready America - State/Territory Coordination Hubs
...
### 23. HHS-2026-ACF-ACYF-CA-0037 - Predictive Analytics in Child Welfare Demonstration Grants
...
### 17. HHS-2026-ACL-NIDILRR-REGE-0212 - RERC on AI-Driven Assistive and Rehabilitation Technologies
...
### 18. USDA-NIFA-KFBMB-32830 - Farm Business Management and Benchmarking Competitive Grants Program

- Deadline date: `2026-07-20`
- Prior command: `AGRICULTURE_PARTNER_AND_DATA_GATE`
- Status: `DEADLINE_PASSED_NO_VERIFIED_SEND`
- Official URL: https://simpler.grants.gov/opportunity/a6c41cc0-e597-45c5-8507-1037d8cf7360

### 19. PDR-2600-DC-029Q - Mass Market Solutions for Leveraging Robotics and AI Technologies for Home Construction Demonstration
...
- Package status: `DEDICATED_PACKAGE`
- Portal status: `NOT_APPLICABLE_OR_NOT_OBSERVED`
- Readiness: `RECEIPT_BACKED_HISTORICAL_SEND`
- Submission ready: `false`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `ce1a3c0ebab51e6a00b1f833b21d8e91163e8b2efd408c3b8c4cdaefdf9dcde5`

### 2. NASHVILLE-EC-FALL-2026 - Nashville Entrepreneur Center Fall 2026 Accelerators

- Source: `Nashville Entrepreneur Center official site / Gmail newsletter`
- Agency: `Nashville Entrepreneur Center`
- Deadline UTC: `2026-07-18T04:59:00Z`
- Official deadline: The official Nashville Entrepreneur Center reply states that applications are open until 11:59 p.m. on July 17. The message does not name a timezone; America/Chicago is the explicit operational inference.
- Days to close from scan date: `-4`
- Deadline bucket: `past_due`
- Command: `SENT_VERIFIED`
- Eligibility: `APPLICATION_SUBMITTED_PORTAL_CONFIRMATION_OBSERVED`
- Fit: `STRONG_TAKEOFF_MVP_AND_CUSTOMER_VALIDATION_FIT`
- Package status: `PORTAL_ONLY`
- Portal status: `PORTAL_CONFIRMED_RECEIPT_BACKED`
- Readiness: `RECEIPT_BACKED_HISTORICAL_SEND`
- Submission ready: `false`
- Source freshness: `NO_TTL_FEED_DEPENDENCY`
- Deadline actionable: `false`
...
- Claim boundary: This receipt records the portal confirmation page observed after submission. It does not prove acceptance into a cohort, selection, funding, endorsement, validation, revenue, or an award.
- Why now: The portal displayed the bounded confirmation that the application was received. Preserve the receipt and monitor for the stated next-step window; do not describe the application as selected, funded, endorsed, or accepted into a cohort.
- Today work:
...
- Package files:
  ...
  - `grant_submissions/NASHVILLE_EC_FALL_2026/NASHVILLE_EC_OFFICIAL_DEADLINE_CONFIRMATION_2026-07-17.json`
  - `grant_submissions/NASHVILLE_EC_FALL_2026/NASHVILLE_EC_SUBMISSION_RECEIPT_2026-07-17.json`
- Action gate: `PORTAL_SUBMISSION_CONFIRMED`
- Action gates passed: `15/15`
- Action gates open: `0`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `e4ac50f0eb1f534eb16645905a4dc0541f013c7b1198d469340e24b813a27707`

### 3. DARPA-SN-26-97 - Anticipatory Research Program RFI

- Source: `SAM.gov / Gmail sent-folder receipt`
- Agency: `Defense Advanced Research Projects Agency`
- Deadline UTC: `2026-07-17T21:00:00Z`
- Official deadline: July 17, 2026 at 5:00 PM Eastern Time
- Days to close from scan date: `-4`
- Deadline bucket: `past_due`
- Command: `SENT_VERIFIED`
- Eligibility: `NON_PROPRIETARY_RFI_RESPONSE_SENT_BEFORE_DEADLINE`
- Fit: `BOUNDED_RESEARCH_AND_MEASUREMENT_RESPONSE_DELIVERED`
- Package status: `DEDICATED_PACKAGE`
- Portal status: `NOT_APPLICABLE_OR_NOT_OBSERVED`
- Readiness: `RECEIPT_BACKED_HISTORICAL_SEND`
- Submission ready: `false`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
- Route: Official notice email route
- Official URL: https://sam.gov/opp/e7e66724a10f4bdc9e327c101347f71e/view
- Freshness blockers:
  - `sam_rush_board:STALE_REVERIFY_REQUIRED`
  - `sam_live_discovery:ZERO_ROW_SAM_RESPONSE_INCONCLUSIVE_BLOCKER`
- Claim boundary: This receipt proves only that Gmail recorded a formal two-attachment package as sent after the agency's same-day guidance, preserves the attachment hashes, and records a later agency response in the same thread. The response does not explicitly confirm either attachment or request further action. This receipt does not prove delivery acceptance, deadline compliance, technical evaluation, independent validation, workshop selection, funding, award, or operational performance.
...
- Source: `OpenAI Build Week / Devpost`
- Agency: `OpenAI / Devpost`
- Deadline UTC: `2026-07-22T00:00:00Z`
...
- Command: `SENT_VERIFIED`
- Eligibility: `SUBMISSION_CONFIRMED_MONITOR_ONLY`
- Fit: `SUBMITTED_DEVELOPER_TOOLS_ENTRY`
- Package status: `PORTAL_ONLY`
- Portal status: `PORTAL_CONFIRMED_RECEIPT_BACKED`
- Readiness: `PORTAL_SUBMISSION_CONFIRMED`
- Submission ready: `false`
- Source freshness: `PORTAL_SUBMISSION_CONFIRMED_RECEIPT_BACKED`
- Deadline actionable: `false`
- Route: Devpost submission manager
- Official URL: https://openai.devpost.com/
- Secondary URL: https://devpost.com/submit-to/30223-openai-build-week/manage/submissions
- Claim boundary: This receipt records the observed YouTube publication state, declared local source-video and narration identities, transcript-QA boundaries, Robert's report that he completed submission, the publicly resolved Devpost page showing ProofLock Console submitted to OpenAI Build Week with the matching video embedded, and Devpost's submission-confirmation email. It does not independently prove that terms were read, contest acceptance beyond successful submission, judging, award, OpenAI endorsement, external validation, engineering performance, safety, patent rights, funding, or commercial readiness.
- Why now: Devpost submission is confirmed by the public project page and confirmation email. Preserve the receipt and monitor for a judging or correction request without describing submission as selection, endorsement, or an award.
- Today work:
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `dff1e9bc6948d48faa33542c22d64268148e9579e4a451c0f2683c8710d32d3e`

### 5. DLA26BZ03-NV011 - Digital Twin of the Organization for Enhanced Mission Readiness

- Source: `DSIP / DLA / SBIR.gov`
...
- Deadline bucket: `48_hour_sprint`
- Command: `STAGE_DSIP_PROPOSAL`
- Eligibility: `OPEN_PHASE_I_SMALL_BUSINESS_IDENTITY_PI_AND_REPRESENTATIONS_UNVERIFIED`
- Fit: `STRONG_TOPIC_FIT_BOUNDED_SYNTHETIC_EVIDENCE_NO_DLA_VALIDATION_CLAIM`
- Package status: `DEDICATED_PACKAGE`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `NOT_READY_HUMAN_GATED`
- Submission ready: `false`
- Source freshness: `NO_TTL_FEED_DEPENDENCY`
- Deadline actionable: `false`
...
- Private values exposed: `false`
- Ready for human final click: `false`
- Next founder action: **Submit the JCP application and retain official evidence**
- Next-action evidence: Hash-matched official JCP receipt PDF or certified DD Form 2345
- All open gates lifecycle-classified once: `true`
- All open gates action-sequenced once: `true`
- Classification can clear a gate: `false`
...
- Source: `Curated Navy topic mirror / DSIP controlling portal`
- Agency: `Department of the Navy`
- Deadline UTC: `2026-07-22T16:00:00Z`
- Official deadline: Closes July 22, 2026 at 12:00 PM ET
- Days to close from scan date: `1`
- Deadline bucket: `48_hour_sprint`
- Command: `REVERIFY_SOURCE_BEFORE_STAGE`
- Eligibility: `REPRESENTATIVE_DATA_AND_COMPLIANCE_GATED`
- Fit: `DRAFT_EVIDENCE_GATED`
- Package status: `DEDICATED_PACKAGE`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `URGENT_NOT_READY`
- Submission ready: `false`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
- Route: DSIP
- Official URL: https://www.dodsbirsttr.mil/submissions/solicitation-documents/active-solicitations
- Secondary URL: https://www.navysbir.com/n26_3/DON26BZ03-NV063.htm
- Freshness blockers:
  - `grant_reviewer_curation:STALE_REVERIFY_REQUIRED`
  - `DSIP_CONTROLLING_NOTICE_RECHECK_REQUIRED`
  - `MANIFEST_REVERIFY_REQUIRED`
- Source authority boundary: The Navy topic page labels itself an unofficial copy. DSIP controls updates and submission requirements.
- Claim boundary: The frozen packet supports a public-AIS controlled-injection comparison only. It does not establish real adversary labels, ADS-B or radar validation, SSDS integration, classified performance, or field readiness.
- Why now: HarborSentinel remains urgent because the curation control publishes a near close and a dedicated local package exists. It is not ready: the controlling DSIP notice, eligibility, portal state, compliance facts, cost approval, and any manifest drift must be resolved before staging.
- Today work:
  - Recheck the complete active solicitation and live DSIP topic before relying on the published close.
  - Close DSIP authority, ownership, foreign-influence, export, cybersecurity, cost, clearance-transition, portal-preview, and domain-review gates; extend the public AIS controlled-injection lane with stronger labels and calibration.
- Human gate:
...
- Package files:
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_PACKAGE_MANIFEST_2026-07-16.json`
  - `grant_submissions/NV063_HarborSentinel/NV063_READINESS.md`
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_ASSEMBLY_MAP_2026-07-16.md`
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_VOLUME1_PUBLIC_TEXT_2026-07-16.md`
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_VOLUME2_FINAL_CANDIDATE_2026-07-16.md`
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_VOLUME2_FINAL_CANDIDATE_2026-07-16.docx`
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_VOLUME3_COST_INPUTS_2026-07-16.md`
  - `grant_submissions/NV063_HarborSentinel/NV063_DSIP_VOLUME5_WORKSHEET_2026-07-16.md`
  - `grant_submissions/NV063_HarborSentinel/build_nv063_dsip_volume2_candidate.py`
  - `grant_submissions/NV063_HarborSentinel/source_attachments/DoW_2026_SBIR_BAA_RELEASE_3_PREFACE.pdf`
  - `grant_submissions/NV063_HarborSentinel/source_attachments/DON_PHASE_I_CONVENTIONAL_VOLUME2_TEMPLATE_2026-03-04.docx`
  - `grant_submissions/NV063_HarborSentinel/source_attachments/DON_PHASE_I_II_VOLUME5_SUPPORTING_DOCS_TEMPLATE_2025-02-12.docx`
  - `grant_submissions/NV063_HarborSentinel/render_qa_20260716_dsip_candidate_v1/NV063_DSIP_VOLUME2_FINAL_CANDIDATE_2026-07-16.pdf`
  - `grant_submissions/NV063_HarborSentinel/render_qa_20260716_dsip_candidate_v1/page-1.png`
  - `grant_submissions/NV063_HarborSentinel/render_qa_20260716_dsip_candidate_v1/page-2.png`
  - `grant_submissions/NV063_HarborSentinel/render_qa_20260716_dsip_candidate_v1/page-3.png`
  - `grant_submissions/NV063_HarborSentinel/render_qa_20260716_dsip_candidate_v1/page-4.png`
  - `grant_submissions/NV063_HarborSentinel/render_qa_20260716_dsip_candidate_v1/page-5.png`
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `489daa222c080d07ae1e0be201a5db3ac4d88b8077df52a56b33d8eab79e5bb7`
...
- Deadline bucket: `48_hour_sprint`
- Command: `REVERIFY_SOURCE_BEFORE_STAGE`
- Eligibility: `SYNTHETIC_ONLY_AND_COMPLIANCE_GATED`
- Fit: `DRAFT_EVIDENCE_GATED`
- Package status: `CONCEPT`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `NOT_READY`
- Submission ready: `false`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
...
- Route: DSIP
- Official URL: https://www.dodsbirsttr.mil/submissions/solicitation-documents/active-solicitations
- Secondary URL: https://www.navysbir.com/n26_3/DON26BZ03-NV065.htm
- Freshness blockers:
  - `grant_reviewer_curation:STALE_REVERIFY_REQUIRED`
  - `DSIP_CONTROLLING_NOTICE_RECHECK_REQUIRED`
- Source authority boundary: The Navy topic page labels itself an unofficial copy. DSIP controls updates and submission requirements.
- Claim boundary: The current benchmark is synthetic. It does not establish real sensor physics, SSDS integration, fire-control performance, classified performance, or field readiness.
- Why now: This curated Navy topic remains visible because its published window is near, but the local material is a concept rather than a dedicated submission package. The controlling DSIP notice and every eligibility, evidence, compliance, cost, and portal gate remain open.
- Today work:
  - Recheck the complete active solicitation and live DSIP topic before relying on the published close.
  - Replace generated sensor archetypes with approved representative assumptions or models; add covariance, latency, and measurement-cost accounting; then close cost, clearance, compliance, portal, and domain-review gates.
- Human gate:
  - Robert verifies current DSIP organization and submitter authority from the live portal.
  - Robert verifies eligibility, representations, cost, attachments, and the final portal preview from current controlling instructions.
- Package files:
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `d34911c08d2c2de3d408f06fc26deb72c21ea8ccc670a489cd0928739569f58e`
...
- Deadline bucket: `48_hour_sprint`
- Command: `REVERIFY_SOURCE_BEFORE_STAGE`
- Eligibility: `BENCHMARK_AND_COMPLIANCE_GATED`
- Fit: `DRAFT_EVIDENCE_GATED`
- Package status: `CONCEPT`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `NOT_READY`
...
- Route: DSIP
- Official URL: https://www.dodsbirsttr.mil/submissions/solicitation-documents/active-solicitations
- Secondary URL: https://www.navysbir.com/n26_3/DON26BZ03-NV061.htm
- Freshness blockers:
  - `grant_reviewer_curation:STALE_REVERIFY_REQUIRED`
  - `DSIP_CONTROLLING_NOTICE_RECHECK_REQUIRED`
- Source authority boundary: The Navy topic page labels itself an unofficial copy. DSIP controls updates and submission requirements.
- Claim boundary: A topic-specific concept exists, but no qualifying trajectory benchmark or operational, classified, or Navy-data performance result is complete.
- Why now: This curated Navy topic remains visible because its published window is near, but the local material is a concept rather than a dedicated submission package. The controlling DSIP notice and every eligibility, evidence, compliance, cost, and portal gate remain open.
- Today work:
  - Recheck the complete active solicitation and live DSIP topic before relying on the published close.
  - Freeze a trajectory benchmark against kinematic, interacting-multiple-model, and historical-pattern baselines on representative AIS/ADS-B data; then close cost, clearance, compliance, portal, and domain-review gates.
- Human gate:
  - Robert verifies current DSIP organization and submitter authority from the live portal.
  - Robert verifies eligibility, representations, cost, attachments, and the final portal preview from current controlling instructions.
- Package files:
  - `grant_submissions/NV061_TrackCast/NV061_CONCEPT_DRAFT.md`
  - `grant_submissions/NV061_TrackCast/NV061_READINESS.md`
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `d5cf00facb520101c526a607de62e5664f0266400ec46088ea009168d6f5909a`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `2399ce7697367c4f984298b34165264a3165d24fb51f14cb73584be8e0a317d6`
...
- Deadline UTC: `2026-08-14T04:59:00Z`
- Official deadline: August 13, 2026 at 11:59 PM Central Daylight Time
- Days to close from scan date: `23`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `9e059c2f45e15688df024c46b62113ae8c3f224ee2d068d135df8f9921f8a1f8`
...
- Days to close from scan date: `9`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `500d05ff1df8ef6dd2f98233e733805eafaa9c01469a8fef395b0195fa8d9482`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `bd6e74e244b4498f7602686bc7c62f30c1e925a9ae77e34ef70dca82a395bab1`
...
- Deadline UTC: `None`
- Official deadline: NSF 26-510 lists July 27 and November 4, 2026, then March 4 and July 7, 2027, as full-proposal deadlines. July 27 is not currently reachable because no official Project Pitch invitation was verified; November 4 is planning only.
- Days to close from scan date: `106`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `c341a53c2bfd54212a930c834977c08940d6c9401e2c9f80c2296e69ee2a58a2`
...
- Package status: `CONCEPT`
- Portal status: `PORTAL_ONLY_UNVERIFIED`
- Readiness: `NOT_READY_FRESHNESS_BLOCKED`
- Submission ready: `false`
- Source freshness: `BLOCKED_REVERIFY_REQUIRED`
- Deadline actionable: `false`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `ae71b50154975aedefc3d7545541026099969af4c81fb82201e267c5d39b05f4`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `64417c7bce6fa28fdde37337f40edb4d2ab15cf49d8c2bfef8673f8c65bad377`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `21a83d8cf020293a0f53e32e4cb5dc46352b4d0d3c2dbdceb11e00e2817d1cb5`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `89cb72eccea3e798a8e73ee9f98936135f47fb704992046207c0829c836b14d9`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `c79adaeb4f184709a66b490f0c33111c2573977a500243820eb8dad9416098c6`
...
- Days to close from scan date: `-8`
- Deadline bucket: `past_due`
- Command: `EXPIRED_NO_SUBMISSION`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `01f2dd27a75c5a3850465dd6d8da508edc3fe6233134d07a7f0adc01f3ca2413`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `b0fce09d443781e96061659706c100680cb3c92fafe23840590ac9467920ffb3`
...
- Days to close from scan date: `-7`
- Deadline bucket: `past_due`
- Command: `PARTNER_OR_NO_BID`
- Eligibility: `OPEN_SOLICITATION_NO_SET_ASIDE`
- Fit: `THEMATIC_MEASUREMENT_FIT_PRIME_DELIVERY_REQUIREMENTS_NOT_MET`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `6f5eeff7698ea4a73a3f8c6a2782bfef3b216d0377db3980f81b6bbd6db00f01`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `0f59050aa6162d898a69688f0a6442f5f2e6c4d39bb5c87f7d1fc3a09379b575`
...
- External send without human: `false`
- Final submit without human: `false`
- Lane SHA-256: `dc5ae3b976fde38c184233345bacfd233c1f97cf0cb5abb0d60a3c43939a802e`
...
- `grants_ranked`: `out/grants/grants_ranked_v2.json` present=`false` sha256=``
- `funding_reviewer_zero_friction_pack`: `out/ops/funding_reviewer_zero_friction_pack_latest.json` present=`false` sha256=``
- `grant_reviewer_curation`: `config/grant_reviewer_curation_v1.json` present=`true` sha256=`4f3176b6140715b0ff7f7ed888ff32deb7b49f16844fb1ebb8980d8d948fc187`
- `grant_reviewer_feed`: `dashboard/data/grant_reviewer_feed.json` present=`true` sha256=`c21c01747cd838ba43a1630ae654c30786f40ac46f4503bb64f1127b22e7dfb7`
- `nv061_concept`: `grant_submissions/NV061_TrackCast/NV061_CONCEPT_DRAFT.md` present=`true` sha256=`0380f76b4563d488c79d63d52f5357074ac3c114f1c4eebb831d121b7448b666`
- `nv061_readiness`: `grant_submissions/NV061_TrackCast/NV061_READINESS.md` present=`true` sha256=`c11e014e00633501333e555a0d6a81614e0a8c620091261a024b80b031d90873`
- `nv063_package_manifest`: `grant_submissions/NV063_HarborSentinel/NV063_DSIP_PACKAGE_MANIFEST_2026-07-16.json` present=`true` sha256=`6aad562aabb6ad58e6a9ad6c98775735a1f3ff1e431cdc597b7258d2b127eed1`
- `nv063_readiness`: `grant_submissions/NV063_HarborSentinel/NV063_READINESS.md` present=`true` sha256=`cd05a68028b989f2e1c55ce29276aeb6d7366f8d385c34826e0af663734e1d85`
- `nv065_concept`: `grant_submissions/NV065_AdaptiveSensorManagement/NV065_CONCEPT_DRAFT.md` present=`true` sha256=`3bf5f4ad287820b574070444d2a79e3dc70bbb70d7122916698bb62943d11475`
- `nv065_readiness`: `grant_submissions/NV065_AdaptiveSensorManagement/NV065_READINESS.md` present=`true` sha256=`0a4d73bfce8e8a9424a25dcd0fbabe62ad845153ea1862e3381dc9e896ef8489`
- `external_submission_receipt`: `grant_submissions/funding_sprint_20260709/EXTERNAL_SUBMISSION_RECEIPT_2026-07-13.json` present=`true` sha256=`0efbfb6b0a6ff3162d602cf69491fe8019ae2a77b6dfb0a20f875f01786896be`
- `cdc_engagement_receipt`: `grant_submissions/funding_sprint_20260709/CDC_AI_ACQUISITION_RFI_ENGAGEMENT_RECEIPT_2026-07-16.json` present=`true` sha256=`68827b9306c9b5cb0861ca434776b22519140b3116244b91b2c27a69f052075c`
- `doj_bop_go_no_go`: `grant_submissions/DOJ_BOP_15BCMS26Q70000005/DOJ_BOP_15BCMS26Q70000005_GO_NO_GO_2026-07-16.md` present=`true` sha256=`0ce8febdb11242535b3b4db56a22a614e51889fc8e97b60098098dfaed83126a`
- `doj_bop_source_manifest`: `grant_submissions/DOJ_BOP_15BCMS26Q70000005/DOJ_BOP_15BCMS26Q70000005_SOURCE_MANIFEST_2026-07-16.json` present=`true` sha256=`2c2b659ab252eca4f3b2f687be87b04d270ef253e93e1b1aa090deefcaa24781`
- `nsf_project_pitch_portal_fields`: `grant_submissions/NSF_Project_Pitch/PROJECT_PITCH_PORTAL_FIELDS_2026-07-16.md` present=`true` sha256=`a05184c695188aa0870ea214ed7fdbab511f4636e3374ef35c0ed373a4826d4f`
...
- `nashville_ec_private_collector`: `code/ops/CAPTURE_NASHVILLE_EC_PRIVATE_FACTS.py` present=`true` sha256=`99c701ac3d140ac8660a8911badb72d77dd42c093859b40ce60117fde85d9659`
- `nashville_ec_private_validator`: `code/ops/VALIDATE_NASHVILLE_EC_PRIVATE_FACTS.py` present=`true` sha256=`3839b6eb35c958f66ad58a2933038bf802d7a45edc1c7deafb19064880e36583`
- `nashville_ec_private_workflow`: `grant_submissions/NASHVILLE_EC_FALL_2026/NASHVILLE_EC_PRIVATE_FACT_CAPTURE_WORKFLOW_2026-07-17.md` present=`true` sha256=`1582f5ae5d723ee4428858d4bed67db0a4c84983a12f00ea30d6b84bb891ab51`
- `nashville_ec_deadline_preservation_receipt`: `grant_submissions/funding_sprint_20260709/NASHVILLE_EC_DEADLINE_PRESERVATION_ENGAGEMENT_RECEIPT_2026-07-17.json` present=`true` sha256=`c072cefa57b60ee99acc64cb7ec7b2e691ef1ee180c458c156593123778aa8ed`
- `nashville_ec_deadline_response_control`: `grant_submissions/funding_sprint_20260709/NASHVILLE_EC_DEADLINE_PRESERVATION_RESPONSE_CONTROL_2026-07-17.md` present=`true` sha256=`3e00b4ee5b717b37e65f66a334434949e3711496ac03df76051cfeb510d7b1d9`
...
- `openai_build_week_submission_receipt`: `evidence/openai_build_week/prooflock_youtube_publication_receipt_20260721.json` present=`true` sha256=`127d3286581634e34592c420cad6d109c119570947c210ec1fcc653f578f3c14`
...
- `erdc_phase2_rom_workflow`: `grant_submissions/funding_sprint_20260709/ERDC_SDC_PHASE2_ROM_APPROVAL_WORKFLOW_2026-07-17.md` present=`true` sha256=`700eb88a4d11d2067402170941204d2c5dbf1776e219da8b77935e4a7f0fe6b7`
