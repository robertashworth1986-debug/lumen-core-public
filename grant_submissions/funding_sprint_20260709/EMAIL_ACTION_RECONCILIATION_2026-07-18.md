...
|---|---|---:|---|
| Nashville Entrepreneur Center | `PORTAL_SUBMISSION_CONFIRMED` | `false` | Monitor for the rolling review result through August 3; do not resubmit, reply to the automated confirmation, or describe the application as selected. |
...
| SAM.gov account credential control | `ACCOUNT_ACTION_REQUIRED_NO_EMAIL_REPLY` | `false` | Complete the authenticated account rotation and hidden local install; do not reply to renewal solicitations or publish the credential. |
