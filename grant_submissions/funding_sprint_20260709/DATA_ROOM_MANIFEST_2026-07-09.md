...
- Manifested Markdown artifacts: `33`
- Control artifacts: `30`
...
- Manifest seed SHA-256: `36b1f0561d06a39ed9502a7bb0a32e3cdca7f84187dca6de3cbf17f08eeb8922`
- Data-room manifest SHA-256: `089e2237cf768c872520562b93d001d43fdf3b8ba4f69d1d169545500d9a9e54`
...
- `front_door_control` `grant_submissions/funding_sprint_20260709/AGENCY_ACCOUNT_ACTIVATION_DOCKET_2026-07-09.md` sha256=`47eead8ccd081ae7c807a8dc784f6ce23b4957d9cb96f35900c068a4ed73f000` bytes=`12244`
...
- `front_door_control` `grant_submissions/funding_sprint_20260709/EVTIT_TECHNICAL_SPRINT_SCOPE_PACKET_2026-07-09.md` sha256=`f8d24dae2c8367f3442aa3d2b2770d88b7087dd16e21ce442530feabbb2e9707` bytes=`8261`
...
- `front_door_control` `grant_submissions/funding_sprint_20260709/FEDERAL_SUBMISSION_PROTOCOL_PACKET_2026-07-09.md` sha256=`8309c5a53faddef22112ca09de2e4742f79e1ec7426080b0a45646e25d587aaf` bytes=`10709`
...
- `front_door_control` `grant_submissions/funding_sprint_20260709/FUNDING_SPRINT_REVIEWER_GATE_2026-07-09.md` sha256=`d5dc874d8f5d9652d5186da9844a8da17868e8d440af4077399d77797ab7a25c` bytes=`6279`
...
- `present` `out/ops/funding_sprint_reviewer_gate_latest.json` control=`funding_sprint_reviewer_gate` role=`machine_control_json` sha256=`7f74e2f4d822bba71f58a933f95958bfbed174750be20a092547ac72301b4086`
- `present` `dashboard/data/funding_sprint_reviewer_gate.json` control=`funding_sprint_reviewer_gate` role=`dashboard_control_json` sha256=`7f74e2f4d822bba71f58a933f95958bfbed174750be20a092547ac72301b4086`
...
- `present` `out/ops/federal_submission_protocol_packet_latest.json` control=`federal_submission_protocol_packet` role=`machine_control_json` sha256=`3cbd27bfe5966b188e92d78206d00c69251040398529585e24609482f3bf56d8`
- `present` `dashboard/data/federal_submission_protocol_packet.json` control=`federal_submission_protocol_packet` role=`dashboard_control_json` sha256=`3cbd27bfe5966b188e92d78206d00c69251040398529585e24609482f3bf56d8`
- `present` `out/ops/agency_account_activation_docket_latest.json` control=`agency_account_activation_docket` role=`machine_control_json` sha256=`f582229736312603ed16f477a16460d53dd8f3baa5c9061f2a51c272a0515f85`
- `present` `dashboard/data/agency_account_activation_docket.json` control=`agency_account_activation_docket` role=`dashboard_control_json` sha256=`f582229736312603ed16f477a16460d53dd8f3baa5c9061f2a51c272a0515f85`
...
- `present` `out/ops/evtit_technical_sprint_scope_packet_latest.json` control=`evtit_technical_sprint_scope_packet` role=`machine_control_json` sha256=`4db494c32be84e0e339cd295f10f72dcda4ddc8a89d5d5b3bb0c876fad3c9cbe`
- `present` `dashboard/data/evtit_technical_sprint_scope_packet.json` control=`evtit_technical_sprint_scope_packet` role=`dashboard_control_json` sha256=`4db494c32be84e0e339cd295f10f72dcda4ddc8a89d5d5b3bb0c876fad3c9cbe`
