...
- Manifested Markdown artifacts: `36`
- Control artifacts: `34`
...
- Manifest seed SHA-256: `4055432ea3fc1c268e2b67f14c15bf84b1b01ae637c7904ac00dc52f4514f998`
- Data-room manifest SHA-256: `d6ba6f7f4dede24ae5e8a7c12cb7ea1036c0630c5957105ad535b7f556a65f74`
...
- `front_door_control` `grant_submissions/funding_sprint_20260709/AGENCY_ACCOUNT_ACTIVATION_DOCKET_2026-07-09.md` sha256=`6903e94da0afb1aa1c915e12b76528a70c538aebcd7728600c623558282fbebe` bytes=`12244`
...
- `sync_receipt` `grant_submissions/funding_sprint_20260709/E_DRIVE_SYNC_RECEIPT_2026-07-09.md` sha256=`db8ef6413acaa602fd2f9570ed71edbd4e4e1eb9bbe2fc08cd0281b22990b6a9` bytes=`1825`
...
- `front_door_control` `grant_submissions/funding_sprint_20260709/FUNDING_SPRINT_REVIEWER_GATE_2026-07-09.md` sha256=`dbdf7ee19bc1f1efc4185b8aa89bd815caa2dfe14950a2f3537a075966f8d6f0` bytes=`6279`
...
- `present` `out/ops/funding_sprint_reviewer_gate_latest.json` control=`funding_sprint_reviewer_gate` role=`machine_control_json` sha256=`f84f16aa6df0a22f2b6ab51fad9b639d34bff50cdf1c8c3ab2dd79958892ee6e`
- `present` `dashboard/data/funding_sprint_reviewer_gate.json` control=`funding_sprint_reviewer_gate` role=`dashboard_control_json` sha256=`f84f16aa6df0a22f2b6ab51fad9b639d34bff50cdf1c8c3ab2dd79958892ee6e`
...
- `present` `dashboard/data/reviewer_concierge_packet.json` control=`reviewer_concierge_packet` role=`dashboard_control_json` sha256=`820ae46ed38630d5b748adb83770d92717cefacf3ebcf6bc3b78ca745969579e`
- `present` `out/ops/human_action_docket_latest.json` control=`human_action_docket` role=`machine_control_json` sha256=`2da42c126052fcc84e35d27ae9c29198f5f3bd0a813ade5d080517ab9ff9a084`
- `present` `dashboard/data/human_action_docket.json` control=`human_action_docket` role=`dashboard_control_json` sha256=`2da42c126052fcc84e35d27ae9c29198f5f3bd0a813ade5d080517ab9ff9a084`
- `present` `out/ops/submission_authority_matrix_latest.json` control=`submission_authority_matrix` role=`machine_control_json` sha256=`157a95c4f9607beba3fa7aa9894c586a80cec2ace86632b60b2bc567baf7239c`
- `present` `dashboard/data/submission_authority_matrix.json` control=`submission_authority_matrix` role=`dashboard_control_json` sha256=`157a95c4f9607beba3fa7aa9894c586a80cec2ace86632b60b2bc567baf7239c`
- `present` `out/ops/reviewer_decision_brief_latest.json` control=`reviewer_decision_brief` role=`machine_control_json` sha256=`b68e3b73cee244fa5c2caa2d4dd5c7921830de512dfa8fa4cd27bb7168162633`
- `present` `dashboard/data/reviewer_decision_brief.json` control=`reviewer_decision_brief` role=`dashboard_control_json` sha256=`b68e3b73cee244fa5c2caa2d4dd5c7921830de512dfa8fa4cd27bb7168162633`
...
- `present` `out/ops/reviewer_diligence_qa_matrix_latest.json` control=`reviewer_diligence_qa_matrix` role=`machine_control_json` sha256=`123049bd39ee103379c5940a4a80d0d24e73d5ecb4db251ad5723a9934b45329`
- `present` `dashboard/data/reviewer_diligence_qa_matrix.json` control=`reviewer_diligence_qa_matrix` role=`dashboard_control_json` sha256=`123049bd39ee103379c5940a4a80d0d24e73d5ecb4db251ad5723a9934b45329`
...
- `present` `out/ops/federal_submission_protocol_packet_latest.json` control=`federal_submission_protocol_packet` role=`machine_control_json` sha256=`67e0c97d97eaad6b2d3d97e212214ca089c025057fb3b117a87c042591085adb`
- `present` `dashboard/data/federal_submission_protocol_packet.json` control=`federal_submission_protocol_packet` role=`dashboard_control_json` sha256=`67e0c97d97eaad6b2d3d97e212214ca089c025057fb3b117a87c042591085adb`
- `present` `out/ops/agency_account_activation_docket_latest.json` control=`agency_account_activation_docket` role=`machine_control_json` sha256=`6b7d611726d57c67eea04429e8e8cbf1ee822fec630865b29049264b79a7f7ae`
- `present` `dashboard/data/agency_account_activation_docket.json` control=`agency_account_activation_docket` role=`dashboard_control_json` sha256=`6b7d611726d57c67eea04429e8e8cbf1ee822fec630865b29049264b79a7f7ae`
...
- `present` `dashboard/data/traction_followup_packet.json` control=`traction_followup_packet` role=`dashboard_control_json` sha256=`e82ac1ef626d962395244228f0506b1cb7a914594a87a58f0d71c1232ff53178`
