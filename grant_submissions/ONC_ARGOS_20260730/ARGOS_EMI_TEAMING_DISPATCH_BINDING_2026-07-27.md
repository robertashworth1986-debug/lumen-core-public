...
- Snapshot UTC: `2026-07-27T22:38:14Z`
- Checks: `12/12` passed; `0` failed
- Send authorized: `false`
- Send performed: `false`
- Approval window: `2026-07-27T22:38:14Z` through `2026-07-27T22:43:14Z`
...
| `DEADLINE_ORDER` | `PASS` | The snapshot precedes the partner target, which precedes the Government deadline. | generated_utc=2026-07-27T22:38:14Z; partner_target_utc=2026-07-28T17:00:00Z; government_deadline_utc=2026-07-30T21:00:00Z |
...
| `FRESH_DRAFT_READBACK` | `PASS` | The current Gmail draft readback matches the exact route, subject, body, and empty attachment set. | age_seconds=17; draft_present=True; sent=False |
...
`APPROVE ONE ARGOS TEAMING DISPATCH: recipient EMI Advisors LLC / Evelyn Gallego; template INITIAL_PARTNER_TEAMING_INQUIRY; binding SHA-256 41B4F157017C7E7A27BCE4284834A23C317D1CC7891AD212B924AD5D938620FB; subject SHA-256 80FEEDC1540F859AC970FD32A3F9DFF0E03C5B347130C7FFF2E4E24382C5993B; body SHA-256 A102BBD27E2BAFBA744D0FD1ADE40565F2D8A97B970A0962344E5E70776EC6E2; attachment set SHA-256 EBD556927E470484600924709BAA4E88A21379E9163BC37AB00E4AAD4886BEA8; expires 2026-07-27T22:43:14Z.`
...
At action time, repeat the full-mailbox duplicate search and Gmail draft readback, update the source gate timestamps and counts, rebuild this binding, then accept only the newly displayed unexpired exact approval phrase. Do not send if any bound field changes.
