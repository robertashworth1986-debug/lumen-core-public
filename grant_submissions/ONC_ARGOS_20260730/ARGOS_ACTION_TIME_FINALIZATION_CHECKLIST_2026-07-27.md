# Project Argos Action-Time Finalization Checklist

**Notice:** `ONC-ARGOS-SSN-2026-OS351107`

**Deadline:** July 30, 2026 at 5:00 PM Eastern / 4:00 PM Central

**Current decision:** `BLOCK_SEND`

## Official Response Requirements

- Maximum 10 content pages; cover page excluded.
...
- [ ] Legal company name matches the current SAM entity record.
- [ ] UEI and DUNS, if applicable, are confirmed from the private record.
- [ ] Company address is current and authorized for submission.
- [ ] Authorized point of contact name and title are confirmed.
- [ ] Telephone and email are confirmed.
- [ ] Small-business designations and SAM registration status are current.
...
- [ ] Final recipient, subject, body, and one attachment set are displayed
  together for review.
- [ ] Exact action-time approval names that recipient, subject, body, and
  attachment hash.
- [ ] Sent receipt is preserved without exposing private identifiers.

Suggested approval form:
