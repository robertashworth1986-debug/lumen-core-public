...
| --- | --- | --- | --- | --- |
| `OFFICIAL_NOTICE_CURRENT` | `PASS` | `true` | The official notice is active and its identity and deadline are explicit. | https://sam.gov/opp/062cef11f5384443bfd84bf123404026/view; checked_utc=2026-07-28T17:21:48Z; age_seconds=10681; amendment_observed=False |
| `OFFICIAL_SOW_SOURCE_CUSTODY` | `PASS` | `true` | The official four-page draft SOW attachment is preserved with exact binary custody. | bytes=174359; sha256=6a1608c024bd87b0204370baab58b0a218c044d403bce6dbe0cfb5164faf6354; source_receipt_sha256=bef28a26ac6a496d3f1fc5f0a92aaa6e52cbc601b32d0ba831aa204533362414 |
...
| `DEADLINE_OPEN` | `PASS` | `true` | The response is evaluated before the exact Government deadline. | evaluated=2026-07-28T20:19:49Z; deadline=2026-07-30T21:00:00Z |
