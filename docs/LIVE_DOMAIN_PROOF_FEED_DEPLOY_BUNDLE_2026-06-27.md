...
Generated UTC: `2026-07-01T11:45:40Z`
Bundle root: `C:\LumaTrader\INSTITUTIONAL_STACK_V2\.deploy_stage\live_domain_proof_feeds_20260701T114540Z`
Archive: `C:\LumaTrader\INSTITUTIONAL_STACK_V2\.deploy_stage\live_domain_proof_feeds_20260701T114540Z.tgz`
...
|---|---:|---|---:|---|
| `champion_metric_gauntlet` | `true` | `dashboard/data/champion_metric_gauntlet.json` | `2` | `4b6f4abecf2c` |
...
| `live_domain_deployment_feed` | `false` | `dashboard/data/live_domain_deployment_feed.json` | `2` | `53b7bd56249d` |
...
| `luma_operator_context` | `false` | `dashboard/data/luma_operator_context.json` | `2` | `2d993948cc67` |
| `champion_phase_proxy_diagnostics` | `false` | `dashboard/data/champion_phase_proxy_diagnostics.json` | `2` | `259ee745a7d0` |
| `safe_key_provider_ping` | `false` | `dashboard/data/safe_key_provider_ping.json` | `2` | `540a1c5be58e` |
| `live_source_measurement_maximizer` | `false` | `dashboard/data/live_source_measurement_maximizer.json` | `2` | `457c924a3e9e` |
| `geometry_live_wiring_matrix` | `false` | `dashboard/data/geometry_live_wiring_matrix.json` | `2` | `1422f81c3cef` |
...
| `rolling_champion_gate` | `false` | `dashboard/data/rolling_champion_gate.json` | `2` | `d7129404a21f` |
| `top_geometry_live_replay_results` | `false` | `dashboard/data/top_geometry_live_replay_results.json` | `2` | `2640d0d9df05` |

## Commands

- Dry run: `.\deploy\PUSH_PROOF_FEEDS_TO_VPS.ps1 -BundleRoot "C:\LumaTrader\INSTITUTIONAL_STACK_V2\.deploy_stage\live_domain_proof_feeds_20260701T114540Z" -DryRun`
- Deploy feeds: `.\deploy\PUSH_PROOF_FEEDS_TO_VPS.ps1 -BundleRoot "C:\LumaTrader\INSTITUTIONAL_STACK_V2\.deploy_stage\live_domain_proof_feeds_20260701T114540Z"`
...
Bundle SHA-256: `42354f4eeed4b5223c644802e48b59132138cff825ee999889c2c1cf29a381d9`
Archive SHA-256: `fc9663648b454fa527a21bd6684a85ddf8de3b21447e23173a7875a043e71aaa`
