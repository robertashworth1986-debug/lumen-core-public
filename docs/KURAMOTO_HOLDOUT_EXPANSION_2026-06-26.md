...
This is stronger than the prior four-route replay because it broadens the held-out source-conditioned routes. It still cannot be called field validation until an external buyer, agency, lab, or system owner supplies or approves the held-out operational data, baseline, acceptance metric, and economic conversion.
