...
Generated UTC: `2026-07-05T20:57:05.015394+00:00`

## Summary

- Lanes: 12
- Families: 140
- Fresh measured sources: 23
- Fresh failed/thin sources: 4
- Total measured rows: 1303
- EIA status: `MEASURED` with 120 rows
- Estimated annual source surface: $20,586,213,130.80
- Lanes ready for live replay build: 12
- Top live replay source-map cards: 5
- Top replay cards ready for build: 5
- Top replay measured source links: 26
- Ready for live geometry claim: `false`
- Ready for real-dollar claim: `false`
- Kraken live execution allowed: `false`
- Boundary: Fresh live-source wiring is stronger evidence than synthetic-only tests, but it is not field validation, realized savings, award certainty, or trading profit.

## Top Live Replay Source Map

| Rank | Lane | Candidate | Best Baseline | Measured Sources | Blocked Sources | Ready |
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | `optimal_curve_transport` | `brachistochrone_descent` | `minimum_jerk_curve` | KRAKEN_PUBLIC, COINGECKO_PUBLIC, FRED, GRANTS_GOV, EIA | none | `true` |
| 2 | `wave_resonance_timing` | `kuramoto_phase_coupling` | `kalman_filter` | EIA, FRED, KRAKEN_PUBLIC, NOAA_NCEI, NASA | none | `true` |
| 3 | `branching_transport` | `leaf_veins` | `minimum_spanning_tree` | EIA, NOAA_NCEI, USGS_WATER, WEBHOOK | NREL | `true` |
| 4 | `thermal_ventilation` | `thermal_plume_convection` | `straight_duct` | EIA, NOAA_NCEI | NREL | `true` |
| 5 | `time_series_model_routing` | `fractal_brownian_surface` | `` | FRED, BEA, BLS, CENSUS, NOAA_NCEI, KRAKEN_PUBLIC, FINNHUB, TWELVE_DATA, ALPHAVANTAGE, MASSIVE | none | `true` |
...
- Score: 159.24
- Measured sources: FRED, BEA, BLS, CENSUS, NOAA_NCEI, KRAKEN_PUBLIC, FINNHUB, TWELVE_DATA, ALPHAVANTAGE, MASSIVE
...
- Safe claim: This lane has fresh measured source paths and can be queued for frozen live replay; it is not field validation, not realized savings, and not an award-certainty or profit claim.

### 2. stability_diagnostic
...
- Score: 97.756
- Measured sources: EIA, FRED, KRAKEN_PUBLIC, NOAA_NCEI, NASA
- Blocked sources: none
...
- Score: 74.14
- Measured sources: BLS, FRED, BEA, WEBHOOK
- Blocked sources: none
- Generated champion: `none`
...
### 7. field_guided_control

- Score: 73.9
- Measured sources: NOAA_NCEI, NASA, USGS_WATER, KRAKEN_PUBLIC
- Blocked sources: none
- Generated champion: `none`
...
- Score: 70.58
- Measured sources: NOAA_NCEI, GRANTS_GOV, KRAKEN_PUBLIC, WEBHOOK
- Blocked sources: none
- Generated champion: `none`
...
### 9. branching_transport

- Score: 66.442
- Measured sources: EIA, NOAA_NCEI, USGS_WATER, WEBHOOK
...
### 12. thermal_ventilation

- Score: 47.764
- Measured sources: EIA, NOAA_NCEI
- Blocked sources: NREL
