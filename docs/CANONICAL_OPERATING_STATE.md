...
Source verification: 17 targeted accounting, public-boundary, source-drift and offer-consistency tests pass using the standard-library test runner because pytest is absent in the review environment. All eight generated pages match their builder. This is a source-level repair pending PR review and the separately controlled public release; no deployment or private runtime restoration is claimed. Visual browser QA of the revised pages remains pending.
