...
- Generated UTC: `2026-07-14T17:02:11.425669+00:00`
...
- Cards with paired inference / positive after Holm: `5` / `0`
- Registered baseline comparisons / mean wins / global-Holm wins: `21` / `19` / `2`
- Cards beating all registered baselines by mean / global Holm: `4` / `0`
- Time-series measured sources/series: `5` / `8`
- Energy pressure rows/windows: `190` / `24`
- Energy pressure max band: `high`
- Energy pressure phase-locked improvement: `36.387422`%
- Rolling champions / triple-source candidates: `5` / `0`
...
## Step Results
- `safe_key_provider_ping`: ok `true`, return `0`
- `live_breadth_key_gate`: ok `true`, return `0`
- `live_source_measurement_maximizer`: ok `true`, return `0`
- `geometry_live_wiring_matrix`: ok `true`, return `0`
- `top_geometry_live_replay_results`: ok `false`, return `None`
- `energy_price_pressure_forecast`: ok `true`, return `0`
- `rolling_champion_gate`: ok `true`, return `0`

## Five Immediate Evidence Moves
...
- Keep the current claim language at live-context replay, not field validation, until a named external site or partner confirms outcomes.
