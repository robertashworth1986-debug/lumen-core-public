...
1. Fix Navy_TrackCast benchmark failures.
2. Build one-page agency technical abstracts.
3. Build reviewer-safe benchmark table.
4. Map budget to milestones.
5. Add transition/commercialization path.
6. Add letters of support or pilot validation.
7. Finish final portal field mapping.