...
- Unique source estimated rows: `3799850`
- Estimated mapped rows: `9845413`
...
- Manifest SHA-256: `2f385d9131277ff75e1009f8458113a20a14ad2044d62593786b32f112a68449`

## Lane Summary

| Lane | Candidate | Baseline | Sources | Rows | Ready Rows |
| --- | --- | --- | --- | --- | --- |
| `wave_resonance_timing` | `kuramoto_phase_coupling` | `kalman_filter` | `147` | `2880414` | `147` |
| `energy_price_pressure_proxy` | `phase_locked_residual_corrector` | `best_named_forecast_baseline` | `144` | `2880414` | `144` |
...
| `market_signal_geometry` | `fractal_brownian_surface` | `autoregressive_baseline` | `145` | `2438909` | `0` |
| `unclassified` | `` | `` | `27` | `665213` | `0` |
