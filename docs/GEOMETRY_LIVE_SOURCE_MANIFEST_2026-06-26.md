...
Generated UTC: `2026-07-01T13:03:26.822590+00:00`
...
- Manifest rows: `497`
- Ready-for-benchmark rows: `313`
- Unclassified rows: `27`
- Mapped lanes: `8`
- Unique source files: `186`
- Unique source estimated rows: `3835921`
- Estimated mapped rows: `9845371`
...
- Manifest SHA-256: `a0e331400b5173212aa32644f46eb19e890a1067594ef7822bb3354502445160`

## Lane Summary

| Lane | Candidate | Baseline | Sources | Rows | Ready Rows |
| --- | --- | --- | --- | --- | --- |
| `wave_resonance_timing` | `kuramoto_phase_coupling` | `kalman_filter` | `147` | `2880400` | `147` |
| `energy_price_pressure_proxy` | `phase_locked_residual_corrector` | `best_named_forecast_baseline` | `144` | `2880400` | `144` |
...
| `market_signal_geometry` | `fractal_brownian_surface` | `autoregressive_baseline` | `145` | `2438895` | `0` |
