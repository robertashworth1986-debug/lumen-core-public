...
| External validation authority docket | Archived GitHub run 29337177292 verifies 6/6 artifact checksums; evaluator invitation is ready | Current maturity remains Level 3; no evaluator is named and Level 4/5 gates remain closed |
...
The [`External Validation Authority Docket`](docs/EXTERNAL_VALIDATION_AUTHORITY_DOCKET_2026-07-14.md) gives an independent evaluator one bounded decision: accept or decline authority to supervise the frozen EIA prospective experiment. It archives the successful clean-runner receipt, scoped SBOM, logs, and checksum manifest under [`evidence/reproducibility/github_run_29337177292`](evidence/reproducibility/github_run_29337177292), defines exact Level 4 and Level 5 gates, and maps current controls informatively to NIST AI RMF Govern, Map, Measure, and Manage functions.
...
8. Open [`EXTERNAL_VALIDATION_AUTHORITY_DOCKET_2026-07-14.md`](docs/EXTERNAL_VALIDATION_AUTHORITY_DOCKET_2026-07-14.md), verify its archived clean-runner bundle, and require an independent evaluator to complete the authority record before using Level 5 language.
