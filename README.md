...
| Live-source measurement cycle | 25 of 29 enabled sources measured; 2,580 rows; 4 failed or thin | Fresh source measurement, not field validation |
| Locked source-conditioned replay | 404 routes; 2,861 baseline comparisons; 1,458 candidate wins; 1,403 losses or ties | Replay is conditional on its sources, metrics, and baselines |
